      ...
      ImageVector.Builder(
        ...
        .apply {
          path(
            ...
            lineTo(7.68f, 5.1f)
            quadTo(7.4f, 4.82f, 7.4f, 4.41f)
            reflectiveQuadTo(7.7f, 3.7f)
            quadTo(7.98f, 3.42f, 8.4f, 3.42f)
            quadToRelative(0.43f, 0f, 0.7f, 0.28f)
            lineToRelative(1.45f, 1.45f)
            quadToRelative(0.7f, -0.22f, 1.43f, -0.22f)
            reflectiveQuadTo(13.4f, 5.15f)
            lineTo(14.9f, 3.67f)
            quadTo(15.18f, 3.4f, 15.59f, 3.4f)
            reflectiveQuadTo(16.3f, 3.7f)
            quadToRelative(0.27f, 0.27f, 0.27f, 0.7f)
            reflectiveQuadTo(16.3f, 5.1f)
            lineTo(15.35f, 6.05f)
            ...
            reflectiveQuadTo(13.71f, 10.29f)
