...
import heizige.kk.khatkit.app.data.export.LorebookSerializer
import heizige.kk.khatkit.app.data.export.ModeInjectionSerializer
import heizige.kk.khatkit.app.data.export.rememberExporter
import heizige.kk.khatkit.app.data.export.rememberImporter
...
import heizige.kk.khatkit.app.ui.components.ui.ExportDialog
...
private fun ModeInjectionTab(
    ...
    val importer = rememberImporter(ModeInjectionSerializer) { result ->
        result.onSuccess { imported ->
            ...
            Toast.show(importSuccessMsg)
        }.onFailure { error ->
            Toast.show(importFailedMsg.format(error.message))
        }
    }
