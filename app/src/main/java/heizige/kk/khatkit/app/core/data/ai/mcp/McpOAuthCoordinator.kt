package heizige.kk.khatkit.app.core.data.ai.mcp
...
import heizige.kk.khatkit.oauth.OAuthAuthorizationLauncher
            ...
            if (clientId.isNullOrBlank()) {
                ...
                val registration = oauthClient.registerClient(
                    ...
                    request = OAuthHttpClient.ClientRegistrationRequest(
                        clientName = config.commonOptions.name.ifBlank { "KhatKit" },
