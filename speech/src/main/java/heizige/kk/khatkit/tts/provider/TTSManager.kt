package heizige.kk.khatkit.tts.provider

import android.content.Context
import kotlinx.coroutines.flow.Flow
import heizige.kk.khatkit.tts.model.AudioChunk
import heizige.kk.khatkit.tts.model.TTSRequest
import heizige.kk.khatkit.tts.provider.providers.ElevenLabsTTSProvider
import heizige.kk.khatkit.tts.provider.providers.FishAudioTTSProvider
import heizige.kk.khatkit.tts.provider.providers.GeminiTTSProvider
import heizige.kk.khatkit.tts.provider.providers.GroqTTSProvider
import heizige.kk.khatkit.tts.provider.providers.MiMoTTSProvider
import heizige.kk.khatkit.tts.provider.providers.MiniMaxTTSProvider
import heizige.kk.khatkit.tts.provider.providers.OpenAITTSProvider
import heizige.kk.khatkit.tts.provider.providers.QwenTTSProvider
import heizige.kk.khatkit.tts.provider.providers.StepTTSProvider
import heizige.kk.khatkit.tts.provider.providers.SystemTTSProvider
import heizige.kk.khatkit.tts.provider.providers.VolcengineTTSProvider
import heizige.kk.khatkit.tts.provider.providers.XAITTSProvider
